...
def get_housing_data(train_dataset=None, target_column=None):
    ...
    download_url = 'https://drive.google.com/u/7/uc?id=1v56sGeiu9ghgiTz1aY-ZmrKioRfM6Zo1&export=download'
    ...
    mn, mx, mean = df.min(numeric_only=True), df.max(numeric_only=True), df.mean(numeric_only=True)
